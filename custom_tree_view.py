...
class CustomTreeView(QTreeView):
    ...
    def load_xml_to_tree_view(self, xml_path: str, xsd_path: str):
        """
        Завантажує XML у вигляд дерева з валідацією за XSD і встановлює підказки з описами.
        """
        logging(common.logFile, f"{xml_path}, {xsd_path}")
        try:
            ...
            if not xsd_schema.validate(xml_tree):
                # raise RuntimeError(f"XML не відповідає XSD:\n{xsd_schema.error_log}")
            ...
            print(f"Помилка при завантаженні XML: {e}")
