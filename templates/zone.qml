...
<qgis maxScale="0" simplifyLocal="1" minScale="100000000" simplifyDrawingHints="1" styleCategories="Symbology|Labeling|Fields|Forms|AttributeTable|Rendering|Notes" version="3.28.3-Firenze" symbologyReferenceScale="-1" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" simplifyDrawingTol="1" labelsEnabled="0" simplifyMaxScale="1">
      ...
      <symbol alpha="1" force_rhr="0" clip_to_extent="1" type="fill" name="0" is_animated="0" frame_rate="10">
        ...
        <layer pass="0" enabled="1" locked="0" class="SimpleLine">
          <Option type="Map">
            ...
            <Option type="QString" name="dash_pattern_offset" value="6.10623e-16"/>
            ...
            <Option type="QString" name="line_color" value="0,41,254,255"/>
  ...
  <fieldConfiguration>
    <field configurationFlags="None" name="CadastralZoneNumber">
  ...
  <aliases>
    <alias name="" index="0" field="CadastralZoneNumber"/>
  </aliases>
  <defaults>
    <default expression="" field="CadastralZoneNumber" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    <constraint notnull_strength="0" exp_strength="0" constraints="0" field="CadastralZoneNumber" unique_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint desc="" exp="" field="CadastralZoneNumber"/>
  </constraintExpressions>
  <expressionfields/>
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      <column width="-1" hidden="0" type="field" name="CadastralZoneNumber"/>
